...
SELECT SUM("1".c2), SUM("2".c5), SUM("3".c5) FROM r3 "0", r0 "1", r13 "2", r13 "3" WHERE "0".c2="1".c0 and "1".c0="2".c1 and "3".c1="3".c2 and "0".c2<74;
...
SELECT SUM("2".c1), SUM("0".c1), SUM("0".c2) FROM r12 "0", r1 "1", r6 "2", r12 "3" WHERE "0".c2="1".c0 and "1".c0="2".c1 and "3".c1="3".c2 and "3".c0<33199;
...
SELECT SUM("1".c5) FROM r13 "0", r13 "1" WHERE "1".c1="1".c2 and "1".c6=8220;
...
SELECT SUM("3".c3), SUM("2".c1), SUM("3".c6) FROM r8 "0", r0 "1", r13 "2", r13 "3" WHERE "0".c2="1".c0 and "1".c0="2".c2 and "3".c1="3".c2 and "0".c1>7860;
